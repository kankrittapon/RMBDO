...
export const masterCheckpointsList: CheckpointNode[] = [
  ...
  },
  {
    ...
    nextRecommendedStep: "เคลียร์ Olvia Combat Academy (จุดตรวจ #3) เพื่อรับ Obsidian Hammer x12 + Darkstar Black Stone x1 มาอัปเกรด TET ทั้งสองชิ้นที่นี่ให้เป็น PEN",
