...
export const masterCheckpointsList: CheckpointNode[] = [
  ...
  },
  {
    ...
    rewards: [
      ...
      "Obsidian Hammer x15 + Darkstar Black Stone x1 + Gem of Twilight x1"
    ],
  ...
  },
  {
    ...
    category: "LIFE_SKILL",
    shortDesc: "ผ่าน 9-10 คอร์ส Life Skill (Gathering, AFK Fishing, Hunting, Cooking, Alchemy, Processing, Training, Farming, Sailing, Bartering) เพื่อรับ Family Reward",
    requiredAction: "เคลียร์ Academy Pass ของแต่ละสาย Life Skill ให้ครบ - รายละเอียดเควส/จำนวนของแต่ละคอร์สยังไม่มีแหล่งข้อมูลทางการที่ระบุตัวเลขชัดเจน ต้องดูในเกมจริงที่หน้าต่าง Olvia Academy",
    requirements: ["สำเร็จเควส Olvia Academy Admission (เลเวล 60+)"],
    rewards: ["Life EXP จำนวนมากต่อสาย (ยืนยันว่ามีจาก GM Notes แต่ไม่ระบุจำนวน)", "Carta's Gathering Clothes + Crio's Fishing Chair (รางวัลจบครบทุกคอร์ส, ยืนยันจาก official FAQ)"],
    ...
    nextRecommendedStep: "เริ่มจากคอร์สที่ตรงกับ Life Skill ที่ตั้งใจเล่นเป็นหลักก่อน",
    dataSource: "support.pearlabyss.com FAQ #649 + official GM Notes 'Enroll at Olvia Academy' (naeu.playblackdesert.com) - เควสรายละเอียด/จำนวนยังไม่มีแหล่งทางการยืนยัน",
    lastVerified: "2026-09-03",
    childTaskIds: [
      "ol_gathering_1",
      "ol_fishing_1",
